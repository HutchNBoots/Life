...
## Real milestone artwork + Day 1 "First Step"

The project owner provided real hand-drawn artwork for the goal-milestone seals (an 8-icon sheet plus a separate day-1 shoe icon) and asked for it to replace the placeholder ribbon glyph, the same way spirit-tier artwork was integrated earlier.
