        ...
        <div key={tier.id} className="flex flex-col items-center gap-2">
          {tier.unlocked ? (
            <>
              ...
              <div className="text-center text-[10px] leading-[1.3] text-[rgba(255,218,185,0.7)]">{tier.name}</div>
            </>
          ) : (
            <>
              <div className="aspect-square w-full rounded-full border-[1.5px] border-dashed border-[rgba(255,218,185,0.14)]" />
              <div className="text-center text-[10px] leading-[1.3] text-[rgba(255,218,185,0.25)]">Day {tier.day}</div>
            </>
          )}
        </div>
      ))}
